  ...
  return (
    opened && (
      <div className="fixed left-0 top-0 z-50 flex h-full w-full items-center justify-center bg-white bg-opacity-80">
        <div className="border-default relative  h-auto max-h-[66%] w-1/3 min-w-min overflow-hidden  rounded-2xl border bg-white p-4 shadow-[0_0_20px_0_rgba(0,0,0,0.25)]">
